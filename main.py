...
Selection = st.sidebar.selectbox("Select Option",
                                 ("Heart Disease Detection App", "Exploratory Data Analysis", "Source Code"))
...
if Selection == "Heart Disease Detection App":
    ...
    # load_clf = pickle.load(open('heart-disease-prediction-knn-model.pkl', 'rb'))
    ...
    st.write('Note: This prediction is based on the Machine Learning Algorithm, KNeighborsClassifier.')
